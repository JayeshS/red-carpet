...
class RuleParserTest {
    ...
    fun listAndPercentPercentMatch() {
        val input = "p1: \"1\" and p2: 0%"
        val evalResult = evaluate(input, linkedMapOf(Pair("p1", "1"), Pair("p2", "0")))
        evalResult shouldEqual false
    }
    ...
    private fun evaluate(input: String, inputMap: LinkedHashMap<String, String>): Boolean {
        ...
        val reportingParseRunner = RecoveringParseRunner<Expression>(prsr.Expr())
